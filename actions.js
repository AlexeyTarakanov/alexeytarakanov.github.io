const quotes = [
	...
	'Если я скажу вам цитату Черчилля, вам понравится, но я не знаю цитат',
	...
	'Пытался от себя убежать, но не смог.',
	'******, кроме тебя никто не жаловался на мою вялость!',
	'Мне понравилось. Если б не нога, конечно, везде б успел.',
	'Когда ты ждешь, ты всегда это находишь.',
	'Аутист он, правда, я не знаю, что это значит.',
	'Глотай, Н*****, мы только начинаем!',
	'Это не религия, это случается.',
	'Никого даже нет, чтобы как бы это. Присоединиться.',
	'Я особенный, мне не трудно не пить',
	'Когда разговариваешь с человеком, лучше чтобы он был.',
	'В таком возрасте я бы уже не смеялся.',
	'Мы с тобой разные и это хорошо.',
	'Своими руками делаешь, всегда хорошо получается, даже если говно.',
	'Со временем я понял: лучше не видеть людей',
	'Когда это было насильно, я был против этого...а потом я задумался... потом я сделал следующий шаг: взял лак для ногтей... и на следующей неделе я отказался от букв и начал печатать'
];
