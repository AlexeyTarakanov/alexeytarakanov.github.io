const quotes = [
	...
	'Если я скажу вам цитату Черчилля, вам понравится, но я не его знаю цитат',
	'Прямо в сердце. Но оно, правда, с другой стороны',
	'Здесь не надо искать логику.',
	'Ты уже не молод, давай начнем с этого.',
	'Пик твоей активности уже прошел'
];
